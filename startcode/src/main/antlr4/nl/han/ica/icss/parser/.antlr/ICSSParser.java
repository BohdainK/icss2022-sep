// Generated from /Users/bohdain/Documents/GitHub/icss2022-sep/startcode/src/main/antlr4/nl/han/ica/icss/parser/ICSS.g4 by ANTLR 4.13.1
...
public class ICSSParser extends Parser {
	...
	public static final int
		RULE_stylesheet = 0, RULE_declaration = 1, RULE_propertyName = 2, RULE_styleRule = 3, 
		RULE_ruleBody = 4, RULE_classSelector = 5, RULE_idSelector = 6, RULE_tagSelector = 7, 
		RULE_selector = 8, RULE_variableAssignment = 9, RULE_variableReference = 10, 
		RULE_boolLiteral = 11, RULE_colorLiteral = 12, RULE_percentageLiteral = 13, 
		RULE_pixelLiteral = 14, RULE_scalarLiteral = 15, RULE_literal = 16, RULE_expression = 17, 
		RULE_ifClause = 18, RULE_elseClause = 19;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "declaration", "propertyName", "styleRule", "ruleBody", 
			"classSelector", "idSelector", "tagSelector", "selector", "variableAssignment", 
			"variableReference", "boolLiteral", "colorLiteral", "percentageLiteral", 
			"pixelLiteral", "scalarLiteral", "literal", "expression", "ifClause", 
			"elseClause"
		};
	}
